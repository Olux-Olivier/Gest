                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="input1_wrapper">
                                        <input type="text" class="input" name="product_name" placeholder="Product Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input1_wrapper">
                            ...
                            <div class="col-md-6">
                                <div class="input1_wrapper">
                                    <input type="text" class="input" name="quantity_in_stock" placeholder="Quantity in stock" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input1_wrapper position-relative">
                                    <input type="text" name="expiry_date" class="input datepicker" placeholder="Expiry date" required>
